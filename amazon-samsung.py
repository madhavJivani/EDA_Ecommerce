...
base_url = 'https://www.amazon.in/s?k=samsung&page={}'
...
for page in range(1, 11):  # Scraping pages 1 to 5
    ...
    if response.status_code == 200:
        ...
        for product_section in product_sections:
            ...
            product_rating = rating_tag.text.split()[0] if rating_tag else "N/A"  # e.g., '4.0 out of 5 stars'
        ...
        file_name = f'amazon_samsung_page_{page}.csv'
